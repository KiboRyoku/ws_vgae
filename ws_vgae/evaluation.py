...
from sklearn.metrics import average_precision_score, roc_auc_score, adjusted_mutual_info_score, adjusted_rand_score
import numpy as np
...
def clustering_latent_space(emb, label, nb_clusters=None):
    """ Community detection: computes AMI and ARI scores from a
    ...
    :return: Adjusted Mutual Information (AMI) and Rand Index (ARI) scores
    """
